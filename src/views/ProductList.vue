<template>
    <div class="product-list-wrap">
        <div class="product-list-content">
            ...
            <VanTabs type="card" color="#1baeae" @click-tab="changeTab">
                <VanTab title="推荐" name=""></VanTab>
                <VanTab title="新品" name="new"></VanTab>
                <VanTab title="价格" name="price"></VanTab>
            </VanTabs>
        </div>

        <div class="content">
            <VanPullRefresh v-model="state.refreshing" @refresh="onRefresh" class="product-list-refresh">
                <VanList>
...
const state = reactive<ProductListState>({
...
const init = async () => {
    ...
    const { data, data: { list } } = await search({
        pageNumber: state.page, goodsCategoryId: categoryId, keyword: state.keyword, orderBy: state.orderBy
    })
